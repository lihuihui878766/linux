...
#define SBI_SSE_EVENT_LOCAL_PMU		(SBI_SSE_EVENT_LOCAL_RAS_RSVD + 1)
#define SBI_SSE_EVENT_LOCAL_ASYNC_PF	(SBI_SSE_EVENT_LOCAL_PMU + 1)
...
#define SBI_ERR_NOT_IMPLEMENTED	-13
#define SBI_ERR_TIMEOUT		-14
#define SBI_ERR_IO		-15
